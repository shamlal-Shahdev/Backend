...
export class UserEntity extends EntityRelationalHelper {
  ...
  @OneToOne(() => UserWalletEntity, (w) => w.user)
  @Exclude({ toPlainOnly: true })
  userWallet: UserWalletEntity | null;

  @OneToOne(() => VendorCompanyProfileEntity, (v) => v.user)
  @Exclude({ toPlainOnly: true })
  vendorCompanyProfile: VendorCompanyProfileEntity | null;
